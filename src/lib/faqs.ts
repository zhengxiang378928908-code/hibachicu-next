export const faqs = [
  ...
  },
  {
    ...
    a: "You only need a flat outdoor space like a backyard, patio, or driveway with enough room for the grill and your guests. We bring the grill, ingredients, utensils, and setup.",
  },
  {
    q: "What areas do you serve?",
    a: "We serve Connecticut, Massachusetts, Rhode Island, Vermont, New Hampshire, New York, New Jersey, Pennsylvania, Delaware, Maryland, Washington D.C., and Florida markets including Miami, Orlando, Tampa, and West Palm Beach.",
  },
  {
