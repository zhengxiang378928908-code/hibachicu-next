...
export const menuStates: MenuState[] = [
  ...
  },
  {
    ...
    serviceAreaIntro:
      "The Miami market is all about property type and access. We quote around whether the event is at a condo, luxury rental, backyard, or waterfront home with its own setup rhythm.",
    serviceAreas: [
      {
        name: "Miami",
        description:
          "Miami bookings are often stylish birthdays, private dinners, and hosted celebrations where the chef show needs to feel energetic and polished.",
        venues: ["private homes", "modern patios", "poolside spaces"],
      },
      {
        name: "Miami Beach",
        description:
          "Miami Beach is ideal for vacation rentals, bachelorette weekends, and higher-touch group dinners where the event atmosphere matters as much as the meal.",
        venues: ["vacation rentals", "courtyard patios", "rooftop spaces"],
      },
      {
        name: "Fort Lauderdale",
        description:
          "Fort Lauderdale works especially well for larger homes, waterfront properties, and weekend groups that want a lively chef experience without leaving the house.",
        venues: ["waterfront patios", "pool decks", "family homes"],
      },
      {
        name: "Aventura",
        description:
          "Aventura bookings usually lean curated and convenience-driven, with demand for private chef nights that feel special without adding stress for the host.",
        venues: ["residential patios", "courtyard spaces", "private homes"],
      },
    ],
    hostingHighlights: [
      {
        title: "Best-fit celebrations",
        description:
          "South Florida hosts most often book for birthdays, vacation weekends, bachelorette dinners, and poolside private events that need both food and momentum.",
      },
      {
        title: "Local planning rhythm",
        description:
          "Condo and rental access drive the logistics in Miami and Miami Beach, while Fort Lauderdale and Aventura are more about property layout and guest count.",
      },
      {
        title: "What makes bookings smooth",
        description:
          "The smoothest Miami-area parties share exact building or gate details early and confirm whether the setup is on a patio, driveway, terrace, or pool deck.",
      },
    ],
    planningChecklist: [
      "South Florida traffic can be unpredictable, so exact property details help us recommend the best service window.",
      "For condos or rentals, confirm elevator, valet, loading, and amenity rules ahead of time.",
      "Poolside and waterfront properties should confirm the hard-surface setup area in advance.",
    ],
    localFaqs: [
      {
        question: "Do you serve vacation rentals and luxury homes in the Miami market?",
        answer:
          "Yes. Miami, Miami Beach, Fort Lauderdale, and Aventura are all strong South Florida markets for hibachi at home and rental-property events.",
      },
      {
        question: "What kinds of Miami-area events book hibachi most often?",
        answer:
          "The most common bookings are birthdays, bachelorette weekends, poolside dinners, vacation-home meals, and private celebrations with a high-energy feel.",
      },
      {
        question: "What should I plan for a Miami hibachi booking?",
        answer:
          "The biggest details are building or gate access, outdoor setup space, and timing around traffic and property rules.",
      },
    ],
    photoGallery: [
      {
        src: "/images/gallery10.jpg",
        alt: "Miami hibachi event inspiration for poolside and vacation-home dinners",
        caption: "A high-energy chef-at-home format for Miami and Miami Beach weekend celebrations.",
        position: "center center",
      },
      {
        src: "/images/gallery7.jpg",
        alt: "Fort Lauderdale hibachi setup inspiration for waterfront homes",
        caption: "The kind of setup Fort Lauderdale hosts book for larger homes and poolside events.",
        position: "center center",
      },
      {
        src: "/images/menu-hibachi-table-1.png",
        alt: "Aventura private hibachi chef inspiration for curated home dinners",
        caption: "A polished private dinner style for Aventura homes and intimate hosted events.",
        position: "center center",
      },
    ],
    legacyPaths: [
      "/miami-hibachi-menu",
      "/menu/miami-hibachi-menu",
      "/florida-miami-hibachi-menu",
    ],
  },
  {
    ...
    serviceAreaIntro:
      "The Orlando market mixes local residential bookings with high-volume vacation-home demand, so the planning usually comes down to group size, property rules, and how tightly the day’s schedule is packed.",
    serviceAreas: [
      {
        name: "Orlando",
        description:
          "Orlando bookings are a great fit for birthdays and house-based celebrations where the host wants a fun, easy format after a busy day with the group.",
        venues: ["backyards", "private homes", "covered patios"],
      },
      {
        name: "Winter Park",
        description:
          "Winter Park usually leans more polished and local, with strong demand for birthdays, graduation dinners, and family entertaining at home.",
        venues: ["garden patios", "private homes", "courtyard spaces"],
      },
      {
        name: "Kissimmee",
        description:
          "Kissimmee is one of the strongest markets for large travel groups and vacation-home bookings where hibachi becomes the night’s headline event.",
        venues: ["resort homes", "vacation rentals", "pool decks"],
      },
      {
        name: "Lake Nona",
        description:
          "Lake Nona bookings are a strong fit for modern backyard events and polished family celebrations with a clean, organized setup.",
        venues: ["modern patios", "residential yards", "private home spaces"],
      },
    ],
    hostingHighlights: [
      {
        title: "Best-fit celebrations",
        description:
          "Orlando-area hosts book hibachi most often for family trips, birthdays, graduation dinners, and vacation-home stays that need a fun evening plan on-site.",
      },
      {
        title: "Local planning rhythm",
        description:
          "Kissimmee and resort communities are more rules-driven, while Winter Park and Lake Nona behave more like local home-event markets.",
      },
      {
        title: "What makes bookings smooth",
        description:
          "The smoothest Orlando bookings share the full property details early and make sure dinner timing works around check-in, theme-park plans, or a packed group itinerary.",
      },
    ],
    planningChecklist: [
      "For resort homes and Kissimmee rentals, confirm community rules and entry details ahead of time.",
      "Keep the chef setup close to the seating area so larger travel groups stay engaged with the show.",
      "If the group is coming back from parks or outings, build in a little buffer before the start time.",
    ],
    localFaqs: [
      {
        question: "Are Orlando hibachi bookings good for vacation homes?",
        answer:
          "Yes. Orlando and Kissimmee are some of the strongest vacation-home hibachi markets because the experience works so well for travel groups staying together.",
      },
      {
        question: "Do you also serve local Orlando-area neighborhoods?",
        answer:
          "Yes. We regularly serve Orlando, Winter Park, Lake Nona, Kissimmee, and nearby Central Florida markets.",
      },
      {
        question: "What is the biggest planning detail for an Orlando hibachi event?",
        answer:
          "The biggest detail is the exact property setup, especially if the event is at a resort home or community with entry and timing rules.",
      },
    ],
    photoGallery: [
      {
        src: "/images/gallery8.jpg",
        alt: "Orlando hibachi setup inspiration for vacation-home groups",
        caption: "A fun, high-visibility layout that works well for Orlando and Kissimmee travel groups.",
        position: "center center",
      },
      {
        src: "/images/menu-hibachi-table-2.png",
        alt: "Winter Park private hibachi dinner inspiration for backyard events",
        caption: "A polished home-event format for Winter Park and Lake Nona celebrations.",
        position: "center center",
      },
      {
        src: "/images/gallery1.jpg",
        alt: "Orlando backyard hibachi inspiration for family celebrations",
        caption: "An easy dinner-and-show setup for local birthdays and family gatherings.",
        position: "center center",
      },
    ],
    legacyPaths: [
      "/orlando-hibachi-menu",
      "/menu/orlando-hibachi-menu",
      "/florida-orlando-hibachi-menu",
    ],
  },
  {
    slug: "florida-tampa",
    ...
    serviceAreaIntro:
      "The Tampa market mixes local Gulf Coast home events with destination-style beach stays, so we plan around bridges, drive time, and whether the booking is a primary residence or a rental.",
    serviceAreas: [
      {
        name: "Tampa",
        description:
          "Tampa bookings are ideal for backyard birthdays, family dinners, and larger home celebrations where the hibachi show keeps the energy high without leaving the property.",
        venues: ["backyards", "poolside patios", "family homes"],
      },
      {
        name: "St. Petersburg",
        description:
          "St. Petersburg works well for stylish private dinners, house parties, and social gatherings where the host wants the night to feel special but low-stress.",
        venues: ["courtyard patios", "waterfront homes", "private terraces"],
      },
      {
        name: "Clearwater",
        description:
          "Clearwater is a strong fit for beach stays and family travel groups that want a chef-driven dinner at the home or rental instead of going out.",
        venues: ["vacation rentals", "beach-house patios", "pool decks"],
      },
      {
        name: "Sarasota",
        description:
          "Sarasota bookings often lean premium and destination-driven, with strong demand for seasonal stays, milestone dinners, and longer family weekends.",
        venues: ["coastal homes", "seasonal rentals", "large patios"],
      },
    ],
    hostingHighlights: [
      {
        title: "Best-fit celebrations",
        description:
          "Gulf Coast hosts most often book hibachi for birthdays, beach weekends, family stays, and house-based celebrations where guests want dinner to feel like the event.",
      },
      {
        title: "Local planning rhythm",
        description:
          "Tampa and St. Petersburg are more local-home focused, while Clearwater and Sarasota need more attention to seasonal travel and rental-property planning.",
      },
      {
        title: "What makes bookings smooth",
        description:
          "The smoothest Gulf Coast bookings share the exact property and target dinner time early so we can plan around bridge traffic and weekend congestion.",
      },
    ],
    planningChecklist: [
      "For Clearwater and Sarasota rentals, confirm parking and outdoor setup space with the property before the event week.",
      "Let us know if the event is poolside so we can plan the layout around guest seating and walkway clearance.",
      "Weekend bridge traffic can shift timing, so an early-evening service window is often the safest choice.",
    ],
    localFaqs: [
      {
        question: "Do you serve both Tampa homes and Gulf Coast rentals?",
        answer:
          "Yes. We regularly serve Tampa, St. Petersburg, Clearwater, Sarasota, and nearby Florida Gulf Coast markets.",
      },
      {
        question: "What kinds of Tampa-area hibachi events are most common?",
        answer:
          "The biggest categories are backyard birthdays, beach-week dinners, family gatherings, and travel-group meals at homes or rentals.",
      },
      {
        question: "What should I plan for a Gulf Coast hibachi booking?",
        answer:
          "The most important details are the exact location, outdoor setup surface, and enough timing flexibility to account for busy weekend traffic.",
      },
    ],
    photoGallery: [
      {
        src: "/images/gallery9.jpg",
        alt: "Tampa hibachi setup inspiration for backyard and poolside events",
        caption: "A lively dinner format that works well for Tampa birthdays and family gatherings.",
        position: "center center",
      },
      {
        src: "/images/gallery10.jpg",
        alt: "St. Petersburg and Clearwater private hibachi inspiration for beach stays",
        caption: "The kind of at-home dinner Clearwater and St. Petersburg groups book for coastal weekends.",
        position: "center center",
      },
      {
        src: "/images/menu-hibachi-table-1.png",
        alt: "Sarasota private hibachi chef inspiration for seasonal rentals",
        caption: "A polished setup style for Sarasota homes, rentals, and longer family stays.",
        position: "center center",
      },
    ],
    legacyPaths: [
      "/tampa-hibachi-menu",
      "/menu/tampa-hibachi-menu",
      "/florida-tampa-hibachi-menu",
    ],
  },
];
